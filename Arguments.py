...
# Main parameters
parser.add_argument(
    "--ligand", type=str, help="ligand name", choices=['FE', 'ZN', 'CA', 'MN', 'MG', 'CD', 'CO', 'CU', 'CU1', 'FE2', 'K', 'NA', 'NI'], default='ZN'
)
parser.add_argument(
    "--checkpoints_dir",
    type=str,
    default="Pretrained_model/ZN",
...
parser.add_argument(
    ...
    type=str,
    nargs='+',
    default=['esm', 'chemi','pka', ], #attention the feature order should be the same with first time train when loaded.
    help="esm:1152, chemi:6, geo:3,",
)
...
parser.add_argument(
    "--radius", type=float, default=6.0,  help="Radius to use for the convolution"
)
