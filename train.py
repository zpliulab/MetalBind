...
from models.MetalBind_model import MetalBind
from models.MetalBind_model import EarlyStopping
import numpy as np
import sys
...
if __name__ == '__main__':
    ...
    for epoch in range(1000):
        ...
        # model.prune_latents_if_needed(current_epoch=epoch)
